...
<section class="dashboard">
   ...
   <div class="box-container">
      ...
      <a href="update-am.php" class="btn">መገለጫ አዘምን</a>
      </div>

      <div class="box">
         <h3>የማጣሪያ ፍለጋ</h3>
         <p>የሕልምዎን ንብረት ይፈልጉ</p>
         <a href="search-am.php" class="btn">አሁን ይፈልጉ</a>
      </div>
      ...
      <p>የተዘረዘሩት ንብረቶች</p>
      <a href="my_listings-am.php" class="btn">ሁሉንም ዝርዝሮች ይመልከቱ</a>
      </div>
      ...
      <p>ጥያቄዎች ተቀብለዋል</p>
      <a href="requests-am.php" class="btn">ሁሉንም ጥያቄዎች ይመልከቱ</a>
      </div>
      ...
      <p>ጥያቄዎች ተልከዋል።</p>
      <a href="saved-am.php" class="btn">የተቀመጡ ንብረቶችን ይመልከቱ</a>
      </div>
