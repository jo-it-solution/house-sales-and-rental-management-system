...
$agentType = $_POST['agent_type'];
   ...
   if($select_admins->rowCount() > 0){
      ...
      if($pass != $c_pass){
         ...
         $insert_admin = $conn->prepare("INSERT INTO `agents`(id, name,number,email,password,agent_type) VALUES(?,?,?,?,?,?)");

         $insert_admin->execute([$id, $name,$number,$email,$c_pass,$agentType]);
...
<section class="form-container">
   ...
   <form action="" method="POST">
      ...
      <select name="agent_type" class="box" placeholder="agent type">
         <option name="kello">kelloAgents</option>
         <option name="licenced">licenced agent</option>
         <option name="ayat">Ayat real estate agent</option>
         <option name="noah">Noah real estate agent</option>
         <option name="sunshine">Sun shine real estate Agents</option>
      </select></option><br>
      ...
      <input type="submit" value="add agent" name="submit" class="btn">
   </form>
