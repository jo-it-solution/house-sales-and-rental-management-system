...
<div class="home">
   ...
   <section class="center">0
      ...
      <form action="search.php" method="post">
         <h3><img src="images/logo1.jpg" style="height:90px;width:90px;">ትክክለኛውን ቤትዎን ያግኙ</h3>
 
         <div class="box">
            <p>ቦታ አስገባ  <span>*</span></p>
            <input type="text" name="h_location" required maxlength="100" placeholder="የከተማ ስም አስገባ" class="input">
         </div>
         <div class="flex">
            <div class="box">
         ...
         <input type="submit" value="ንብረት መፈለግ" name="h_search" class="btn">
      </form>
...
<section class="services">
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <h3>ጠፍጣፋዎች እና ህንፃዎች</h3>
         <p></p>
      </div>

      <div class="box">
         <img src="images/icon-5.png" alt="">
         <h3>ሱቆች እና የገበያ ማዕከሎች</h3>
         <p></p>
      </div>
...
<section class="listings">
   ...
   <h1 class="heading">የቅርብ ጊዜ ዝርዝሮች</h1>
   ...
   <div style="margin-top: 2rem; text-align:center;">
      <a href="listings.php" class="inline-btn">ሁሉንም ይመልከቱ</a>
   </div>
