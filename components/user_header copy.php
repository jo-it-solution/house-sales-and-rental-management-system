...
<header class="header">
   ...
   <nav class="navbar nav-1">
      ...
      End
      -->
      <a href="home.php" class="logo"><img src="images/logo1.jpg" style="padding-top:10%;height:45px;width:45px;"><span style="color:orange;">kello</span><span style="border:2px dashed orange;">Betoch</span></a>
