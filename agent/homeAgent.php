...
<div class="home">
   ...
   <section class="center">
      ...
      <form action="search.php" method="post">
         <h3><img src="../images/logo1.jpg" style="height:90px;width:90px;">find your perfect home</h3>
         ...
         <div class="flex">
            <div class="box">
               ...
               <select name="h_type" class="input" required>
                  ...
                  <option value="apartment">real estate</option>
   ...
   <div class="box-container">
      <?php
         ...
         if($select_properties->rowCount() > 0){
            ...
            $select_saved = $conn->prepare("SELECT * FROM `saved` WHERE property_id = ? and agent_id = ?");
            $select_saved->execute([$fetch_property['id'], $agent_id]);
      ...
      <form action="" method="POST">
         ...
         <div class="box">
            <div class="price"><i class="fas"></i><span><?= $fetch_property['price']; ?></span></div>
