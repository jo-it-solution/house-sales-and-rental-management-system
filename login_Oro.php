...
if(isset($_POST['submit'])){
   ...
   if($select_users->rowCount() > 0){
      ...
      $warning_msg[] = 'Maqaa fayyadamaa ykn jecha icciitii sirrii hin taane!';
   }
...
<section class="form-container">
   ...
   <form action="" method="post">
      ...
      <p>herrega hin qabdu? <a href="register.html">haaraa galmeessi</a></p>
      <input type="submit" value="amma seeni" name="submit" class="btn">
   </form>
